        ...
        {workouts.map((workout) => (
          ...
          >
            <div className="flex flex-wrap items-center justify-between gap-4">
              <div>
                <h3 className="text-xl font-semibold">{workout.template_name ?? "Custom Workout"}</h3>
                <p className="text-sm text-muted-foreground">{new Date(workout.logged_at).toLocaleString()}</p>
              </div>
