      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="space-y-2">
          ...
          <Input
            ...
            aria-describedby={exercise.errors.sets ? `sets-error-${exercise.id}` : undefined}
          ...
          {exercise.errors.sets && (
            <p id={`sets-error-${exercise.id}`} className="text-sm text-destructive">
              {exercise.errors.sets}
            </p>
          )}
        </div>
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            aria-describedby={exercise.errors.reps ? `reps-error-${exercise.id}` : undefined}
          ...
          {exercise.errors.reps && (
            <p id={`reps-error-${exercise.id}`} className="text-sm text-destructive">
              {exercise.errors.reps}
            </p>
          )}
        </div>
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            onChange={(e) => onUpdate("default_weight", parseFloat(e.target.value))}
            aria-describedby={exercise.errors.default_weight ? `weight-error-${exercise.id}` : undefined}
          ...
          {exercise.errors.default_weight && (
            <p id={`weight-error-${exercise.id}`} className="text-sm text-destructive">
              {exercise.errors.default_weight}
            </p>
          )}
        </div>
