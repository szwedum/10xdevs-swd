    ...
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2 text-lg">
          <span className="flex h-6 w-6 items-center justify-center rounded-full bg-muted text-sm">{position}</span>
      ...
      <CardContent>
        <dl className="grid grid-cols-3 gap-4">
          ...
          <div>
            ...
            <dd className="text-2xl font-bold">{exercise.default_weight ? `${exercise.default_weight}kg` : "—"}</dd>
          </div>
        </dl>
      </CardContent>
    </Card>
